...
INSERT INTO "new_Post" ("authorId", "content", "createdAt", "groupId", "id", "isDeleted", "linkedPublicationId", "mediaUrl", "mentions", "reactions", "title", "type", "updatedAt", "visibility") SELECT "authorId", "content", "createdAt", "groupId", "id", "isDeleted", "linkedPublicationId", "mediaUrl", "mentions", "reactions", "title", "type", "updatedAt", "visibility" FROM "Post";
DROP TABLE "Post";
