...
export const mockFirmProfiles: Record<string, FirmProfileData> = {
  ...
  'ember-and-oak': {
    id: 'ember-and-oak',
    name: 'Ember & Oak',
    tagline: 'Restaurant & Food Service',
    industry: 'Restaurant & Food Service',
    foundedYear: 2018,
    employeeCount: '42',
    bio: 'Founded in 2018, Ember & Oak brings live-fire cooking to downtown Austin — everything from the ribeye to the mushrooms passes over an open oak fire. We work directly with regional farms and source seasonally, changing the menu with the harvest.',
    firmType: 'SERVICE',
    followersCount: 6200,
    posts: [
      {
        id: 'eo-post-1',
        title: 'Our new seasonal menu just dropped 🔥',
        content: "Fall menu is live tonight. Wood-fired squash, the ribeye is back with a bone marrow butter, and we've got a new Basque cheesecake with roasted fig compote.\n\nReservations are moving fast this week — book ahead if you want a Friday table.",
        timestamp: '2026-07-14T18:30:00.000Z',
        reactions: { likes: 112, comments: 24 },
        mediaUrl: 'https://images.unsplash.com/photo-1481931098730-318b6f776db0?w=800&h=500&fit=crop',
      },
      {
        id: 'eo-post-2',
        title: "We're hiring — line cooks and servers",
        content: "Growing the kitchen and floor team for the fall season. If you've got fine-dining experience and want to work the wood-fired line, we want to hear from you.\n\nOpen roles in the Firm Details tab. 🔥",
        timestamp: '2026-07-05T15:00:00.000Z',
        reactions: { likes: 47, comments: 9 },
      },
      {
        id: 'eo-post-3',
        title: "Thrilled to be featured in Austin Monthly's Best New Restaurants",
        content: "Genuinely didn't expect this one. Huge thanks to the entire kitchen and floor team — this is a reflection of their work every single service, not just one good night.",
        timestamp: '2026-06-22T12:00:00.000Z',
        reactions: { likes: 96, comments: 18 },
        mediaUrl: 'https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=800&h=500&fit=crop',
      },
      {
        id: 'eo-post-4',
        title: 'Wine Dinner Series — reservations now open',
        content: 'Four courses, four wines, one long table. Our next Wine Dinner is the last Thursday of the month, paired around a small Willamette Valley producer we\'ve been buying from for two years.\n\nSeats are limited to 24. Link in bio to reserve.',
        timestamp: '2026-06-10T17:15:00.000Z',
        reactions: { likes: 58, comments: 11 },
      },
      {
        id: 'eo-post-5',
        title: 'Behind the scenes: sourcing local and seasonal',
        content: "Most of what's on the menu this week came from three farms within 90 miles of the restaurant. Sourcing this way costs more and takes more coordination — but the produce tastes like it was picked yesterday, because it was.",
        timestamp: '2026-05-28T10:00:00.000Z',
        reactions: { likes: 41, comments: 6 },
      },
    ],
    services: [
      { title: 'Dine-In', description: 'Reserve a table and enjoy the full wood-fired menu on-site.' },
      { title: 'Private Events & Catering', description: 'Book our private dining room or have us cater your next event.' },
      { title: 'Wine Dinner Series', description: 'Monthly four-course tasting menus paired with small-producer wines.' },
    ],
    menu: [
      { id: 'eo-menu-1', name: 'Charred Octopus', description: 'Wood-fired octopus, smoked paprika aioli, fingerling potatoes.', price: '$18', category: 'Starters' },
      { id: 'eo-menu-2', name: 'Burrata & Heirloom Tomato', description: 'Local burrata, heirloom tomatoes, basil oil, aged balsamic.', price: '$16', category: 'Starters' },
      { id: 'eo-menu-3', name: 'Oak-Smoked Wings', description: 'Slow-smoked wings, house hot sauce, blue cheese.', price: '$14', category: 'Starters' },
      { id: 'eo-menu-4', name: 'Wood-Fired Ribeye', description: '16oz dry-aged ribeye, charred over oak, bone marrow butter.', price: '$52', category: 'Mains' },
      { id: 'eo-menu-5', name: 'Whole Roasted Branzino', description: 'Mediterranean sea bass, citrus, fennel, olive oil.', price: '$34', category: 'Mains' },
      { id: 'eo-menu-6', name: 'Ember-Roasted Chicken', description: 'Half chicken, brined 24 hours, roasted over embers.', price: '$28', category: 'Mains' },
      { id: 'eo-menu-7', name: 'Wild Mushroom Risotto', description: 'Foraged mushrooms, parmesan, truffle oil. Vegetarian.', price: '$24', category: 'Mains' },
      { id: 'eo-menu-8', name: 'Basque Cheesecake', description: 'Torched to order, seasonal berry compote.', price: '$12', category: 'Desserts' },
      { id: 'eo-menu-9', name: 'Dark Chocolate Tart', description: 'Sea salt, hazelnut crumble.', price: '$11', category: 'Desserts' },
      { id: 'eo-menu-10', name: 'Barrel-Aged Old Fashioned', description: 'House barrel-aged for six weeks.', price: '$16', category: 'Drinks' },
      { id: 'eo-menu-11', name: 'Natural Wine Flight', description: "Three pours, sommelier's choice.", price: '$22', category: 'Drinks' },
    ],
    team: [
      {
        name: 'Marcus Delgado', role: 'Executive Chef & Co-Founder', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop&crop=face',
        directReports: [
          { name: 'Rachel Kim', role: 'Sous Chef', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop&crop=face' },
          { name: 'Leo Martinez', role: 'Pastry Chef', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face' },
        ],
      },
      { name: 'Olivia Turner', role: 'General Manager & Co-Founder', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&h=200&fit=crop&crop=face' },
      { name: 'James Whitfield', role: 'Sommelier', avatar: 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=200&h=200&fit=crop&crop=face' },
    ],
    locations: [
      { city: 'Austin', address: '412 Congress Ave, TX 78701', type: 'Main Dining Room' },
      { city: 'Austin', address: '88 Rainey St, TX 78701', type: 'Private Events Space' },
    ],
    insights: { employeeGrowth: '+14%', avgTenure: '2.6 years' },
    portfolio: [
      {
        title: "Featured in Austin Monthly's Best New Restaurants",
        description: 'Recognized alongside the city\'s top openings for our live-fire cooking and seasonal sourcing.',
        category: 'Press Feature',
        result: 'Named one of Austin\'s Best New Restaurants.',
        imageUrl: 'https://images.unsplash.com/photo-1424847651672-bf20a4b0982b?w=800&h=500&fit=crop',
      },
      {
        title: 'Wine Dinner Series Launch',
        description: 'Launched a monthly four-course tasting series paired with small-batch, regional wines.',
        category: 'Events',
        result: 'Sells out within 48 hours of announcement most months.',
        imageUrl: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&h=500&fit=crop',
      },
    ],
    jobs: [
      { id: 'eo-1', title: 'Line Cook', location: 'Austin, TX', type: 'Full-time' },
      { id: 'eo-2', title: 'Server', location: 'Austin, TX', type: 'Part-time' },
      { id: 'eo-3', title: 'Sommelier Assistant', location: 'Austin, TX', type: 'Full-time' },
    ],
    recognitions: [
      { id: 'eo-r1', label: 'Best New Restaurant', sublabel: "Austin Critics' Table · 2019" },
      { id: 'eo-r2', label: "OpenTable Diners' Choice Award", sublabel: '2024' },
    ],
    milestones: [
      { id: 'eo-m1', period: '2026', title: 'Launched seasonal tasting menu', org: 'Menu Milestone' },
      { id: 'eo-m2', period: '2023', title: "Featured in Austin Monthly's Best New Restaurants", org: 'Press Feature' },
      { id: 'eo-m3', period: '2021', title: 'Expanded patio and opened private dining room', org: 'Expansion' },
      { id: 'eo-m4', period: '2019', title: "Won Austin Critics' Table Best New Restaurant", org: 'Award' },
      { id: 'eo-m5', period: '2018', title: 'Opened in downtown Austin', org: 'Austin, TX' },
    ],
    partnerSlugs: ['artisan-bloom', 'ecostream-solutions'],
  },
};
