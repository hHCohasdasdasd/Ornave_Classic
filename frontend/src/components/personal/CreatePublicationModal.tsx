  ...
  return (
    <div className="create-publication-modal-overlay" onClick={reset}>
      <div className="create-publication-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="create-publication-modal__user-section">
          <div className="create-publication-modal__user">
            <div className="create-publication-modal__avatar">
              <div className="create-publication-modal__avatar-placeholder">
                {userName.charAt(0).toUpperCase()}
              </div>
            </div>
            <div className="create-publication-modal__user-info">
              <span className="create-publication-modal__name">{userName}</span>
              <span className="create-publication-modal__kind">Long-form Publication</span>
            </div>
            {user?.companyId && (
              <button
                className="create-publication-modal__company-toggle"
                onClick={() => setPostAsCompany(!postAsCompany)}
              >
                Posting as {postAsCompany ? 'Company' : 'Yourself'} ▾
              </button>
            )}
          </div>
        </div>
        ...
        <div className="create-publication-modal__content">
          <input
            type="text"
          ...
          <textarea
            className="create-publication-modal__textarea"
          ...
          <div className="create-publication-modal__meta-row">
            <input
              type="text"
