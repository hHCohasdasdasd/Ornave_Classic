    ...
    <div className="worksuite-page">
      ...
      <div className="worksuite-page__banner">
        <div className="worksuite-page__banner-inner">
          ...
          <p className="worksuite-page__subtitle">A record of the milestones you've earned — look back and see how far you've come.</p>
        </div>
      </div>
        ...
        {isLoading ? (
          ...
          achievements.map((achievement) => (
            <div key={achievement.id} className="worksuite-achievement">
              ...
              <button className="worksuite-btn worksuite-btn--danger" onClick={() => handleDelete(achievement)}>Delete</button>
            </div>
          ))
        )}
      </div>
