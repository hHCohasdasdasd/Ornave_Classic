...
import { WorkSuiteFinancePage } from '@/pages/WorkSuiteFinancePage';
      ...
      <Router>
        ...
        <CartProvider>
          ...
          <Routes>
            ...
            <Route path="/work-suite/finance" element={<WorkSuiteFinancePage />} />
            <Route path="/plaid-oauth-redirect" element={<PlaidOAuthRedirectPage />} />
